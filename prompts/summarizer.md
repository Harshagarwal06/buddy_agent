...
- "image_prompt": 1-2 sentences describing a single clear visual metaphor that communicates the article's central idea. Describe subjects, relationships, and composition, but do not request text, logos, screenshots, or a visual style.
